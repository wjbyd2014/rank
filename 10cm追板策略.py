...
if __name__ == '__main__':
    zhuiban_strategy = Strategy10cm('10cm追板策略',
                                    ...
                                    {'日期': str, '代码': str, '名称': str,
                                     ...
                                     '1日涨停数': int, '2日涨停数': int, '3日涨停数': int,
                                     '4日涨停数': int, '5日涨停数': int, '6日涨停数': int,
                                     '7日涨停数': int, '10日涨停数': int, '15日涨停数': int, '30日涨停数': int,
                                     '买入价涨幅3': float, '买入价涨幅5': float, '买入价涨幅7': float, '买入价涨幅10': float,
                                     '买入价涨幅15': float, '买入价涨幅30': float,
                                     },
                                    'zhuiban.js',
                                    {},
                                    '每日股票信息.csv',
                                    {'名称': str, '代码': str, '上市天数': float, 'ma3向上': int, 'ma5向上': int,
                                     '昨日是否一字板': int, '10日最大两个天量之和': float
                                     },
                                    'stock_info_day.js',
                                    {},
